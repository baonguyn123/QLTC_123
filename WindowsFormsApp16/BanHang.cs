...
namespace WindowsFormsApp16
{
    public partial class BanHang : Form
    {
        ...
        private void dateNB_ValueChanged(object sender, EventArgs e)
        {

        }

        private void cbNVSP_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void lblslSP_Click(object sender, EventArgs e)
        {
